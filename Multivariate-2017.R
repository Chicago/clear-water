...
df_model <- df[, c("Escherichia.coli", #dependent variable
                   ...
                   ## Removed after transformation (see next line)
                   "DNA.Geo.Mean"
)]

## sub DNA for E. coli. This is for validation only. This will make sure DNA days 1000 and over are 1s and under 1000 are 0s.
df_model[df_model$Year == "2017","Escherichia.coli"] <- df_model[df_model$Year == "2017","DNA.Geo.Mean"] - 765
df_model$DNA.Geo.Mean <- NULL

finaltest <- df_model[df_model$Year == "2017",]
...
testYears <- c("2017")
trainYears <- c("2006", "2007", "2008", "2009","2010", "2011", "2012", "2013", "2014", "2015", "2016")
...
saveRDS(model, paste0("models/", "Multivariate-2017", ".Rds"))

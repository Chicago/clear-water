...
BeachNames<- function(data){
  ...
  cleanbeachnames <- read.csv("~/GitHub/Chicago/e-coli-beach-predictions/data/ChicagoParkDistrict/raw/Standard 18 hr Testing/cleanbeachnames.csv", stringsAsFactors = FALSE)
